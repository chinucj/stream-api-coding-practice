...
public static void main(String[] args) {
	List<Integer> list = Arrays.asList(11,12,11,24,56,66,24,88,34,98,24,57);
	System.out.println(findDuplicate(list));
}

private static List<Integer> findDuplicate(List<Integer> list) {
	return list.stream().
 ...
 * 4. from that stream filter the element whose value greater than one
